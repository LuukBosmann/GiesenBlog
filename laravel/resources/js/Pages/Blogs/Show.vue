               ...
               <div class="flex m-2 p-2">
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg mb-5">
                    <div class="mt-3" v-if="blog.user_id == logged_in">
                        <Link :href="`/blogs/${blog.id}`" method="delete" as="button" type="button" class=" float-right mr-3 inline-flex w-full justify-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-red-700  sm:ml-3 sm:w-auto sm:text-sm">Delete</Link>
                        <Link :href="`/blogs/${blog.id}/edit`"><button type="button" class=" float-right inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">Edit</button></Link>
                    </div>
                           ...
                           <div class="w-full md:w-1/2 flex flex-col flex-grow flex-shrink">
                               <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                                   <div class="w-full flex flex-col items-center">
                                       ...
                                       <div class="w-10/12 font-bold text-3xl text-gray-900 mb-6">{{ blog.titel }}</div>
                                   </div>
