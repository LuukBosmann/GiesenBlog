    ...
    <header class="bg-giesenWhite-100 shadow-md mb-6">
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-4">
            ...
            <div v-if="user == null" class="flex flex-1 justify-end gap-5">
                ...
                <Link href="/registreer" class="font-semibold"> Sign up</Link>
            </div>
            ...
            <div @click="isOpen = !isOpen" v-else class="flex flex-1 justify-end gap-5 relative">
                ...
                <div v-if="isOpen" id="dropdown"
                    ...
                    <Link href="/profiel"
                        class="block px-4 py-2 hover:bg-giesenWhite-400 rounded-t transition-colors duration-300">Profile
                    </Link>
                    <Link href="/mijnBlogs" class="block px-4 py-2 hover:bg-giesenWhite-400 transition-colors duration-300">
                    My blogs</Link>
                    <Link href="/mijnReacties"
                        class="block px-4 py-2 hover:bg-giesenWhite-400 transition-colors duration-300">My comments</Link>
