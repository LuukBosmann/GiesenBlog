...
<template>
    ...
    <div class="container mx-auto mt-8">
        ...
        <div class="flex flex-wrap -mx-4">
            <div v-for="blog in sortedBlogs" :key="blog.id" class="mb-6 w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 px-4">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex-1 text-gray-700">
                            <p class="font-semibold text-md text-blue-500">
                                {{ findUser(props.users, blog.gebruikersId).voornaam }} {{ findUser(props.users,
                                    blog.gebruikersId).achternaam }}
                            </p>
